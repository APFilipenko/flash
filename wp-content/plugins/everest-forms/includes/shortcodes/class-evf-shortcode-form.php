...
class EVF_Shortcode_Form {
	...
	public static function footer( $form_data, $title, $description ) {
		...
		printf(
			"<button type='submit' name='everest_forms[submit]' class='everest-forms-submit-button button evf-submit %s' id='evf-submit-%d' value='evf-submit' %s conditional_rules='%s' conditional_id='%s' %s>Отправить</button>",
