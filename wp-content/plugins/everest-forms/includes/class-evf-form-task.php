...
class EVF_Form_Task {
	...
	public function do_task( $entry ) {
		...
		$message = isset( $this->form_data['settings']['successful_form_submission_message'] ) ? $this->form_data['settings']['successful_form_submission_message'] : __( 'Спасибо что написали нам! В ближайшее время мы с вами свяжемся!', 'everest-forms' );
		if ( '1' === $ajax_form_submission ) {
