...
class EVF_Builder_Settings extends EVF_Builder_Page {
	...
	public function output_content() {
		...
		everest_forms_panel_field(
			...
			array(
				'input_class' => 'short',
				'default'     => isset( $this->form->successful_form_submission_message ) ? $this->form->successful_form_submission_message : __( 'Спасибо что написали нам! В ближайшее время мы с вами свяжемся!', 'everest-forms' ),
