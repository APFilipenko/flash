...
$form_template['contact'] = array(
	...
	'settings'      => array(
		...
		'form_desc'                          => '',
		'successful_form_submission_message' => get_option( 'everest_forms_successful_form_submission_message', __( 'Спасибо что написали нам! В ближайшее время мы с вами свяжемся!', 'everest-forms' ) ),
		'redirect_to'                        => '0',
		'custom_page'                        => '2',
		'external_url'                       => '',
